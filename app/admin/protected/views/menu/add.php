...
<div class="admin-main">
    ...
    <div class="panel dux-box  active">
        <div class="panel-head">
            <strong>当前位置：管理员列表&nbsp;&gt;&nbsp;添加管理员</strong>
        </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="button-group button-group-small radio">
                        <label class="button active"><input name="Power[is_show]" value="1" checked="checked" type="radio">
                        <span class="icon icon-check"></span>是</label>
                        <label class="button"><input name="Power[is_show]" value="0" type="radio">
                ...
                <div class="form-group">
                    ...
                    <div class="button-group button-group-small radio">
                        <label class="button active"><input name="Power[state]" value="1" checked="checked" type="radio">
                        <span class="icon icon-check"></span> 可用</label>
                        <label class="button"><input name="Power[state]" value="0" type="radio">
                ...
                <div class="form-group">
                    ...
                    <div class="button-group button-group-small radio">
                        <label class="button "><input name="Power[isdefault]" value="1"  type="radio">
                        <span class="icon icon-check"></span>是</label>
                        <label class="button active"><input name="Power[isdefault]" value="0" type="radio" checked="checked">
                        <span class="icon icon-times"></span> 否</label>
                    </div>
                    <div class="field">
                        <?php //echo Html::activeRadioList($model, 'state', [0 => '不可用', 1 => '可用'], ['class' => 'input', 'size' => 30]);?>
