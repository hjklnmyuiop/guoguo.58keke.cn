...
$this->title = '海花岛游戏-管理员操作日志';
?>
<div class="dux-tools">
    <div class="tools-function clearfix">
        <div class="float-left">
            <a class="button button-small bg-main icon-list" href="">管理员操作日志</a>
        </div>
    </div>
</div>
<div class="admin-main">
    <div class="panel dux-box">
        ...
        <div class="float-left">
			<?php echo html::beginForm(Url::toRoute(yii::$app->params['url']['adminLog']), 'GET');?>
                <div class="form-inline">
                    ...
                    <div class="form-button">
						...
						<?php if(in_array('eadlog', $power)): $search = (!empty($_GET['search']) ? $_GET['search'] : '')?>
						<?php echo "<a class='button' href='".Url::toRoute([yii::$app->params['url']['eadlog'], 'search'=>$search])."'>导出</a>";?>
						<?php endif;?>
                    </div>
                </div>
