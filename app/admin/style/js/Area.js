...
function changeComplexProvince(f, k, e, d, provinceid) {
...
function changeCity(c, a, t, cityid) {
	var prov = c.substring(0, 2);
	$('#'+ cityid).val(sub_array[prov][c]);
    ...
    for (var i = c * 100; i < _d.length; i++) {
        ...
        str += "<option value='" + _d[i] + "' >" + _d[i] + "</option>";
    }
    $("#" + a).html(str);
