$(function(){
	...
	$('#sidebar-collapse').click(function(){
		...
		if(sidebarStatus){
			$(this).find('i').attr('class', 'icon-angle-double-right');
			$('#sidebar-left').addClass('overflow');
			$('#main-frame').addClass('full');
		}else{
			$(this).find('i').attr('class', 'icon-angle-double-left');
			$('#sidebar-left').removeClass('overflow');
			$('#main-frame').removeClass('full');
		}
	});
